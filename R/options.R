...
##' Default is 10.
##' - `raqs.delay_between_req` controls a delay between API request sent via a
##' function. It occurs when your `bdate` and `edata` inputs span multiple
##' years. A value will be rounded to the nearest integer. Default is 5 seconds.
